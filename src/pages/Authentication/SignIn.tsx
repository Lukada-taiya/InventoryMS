        ...
        <div className="flex flex-wrap items-center justify-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-2/5 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              {error && (<span className='text-red-500 text-md mb-2'>{error}</span>)}
                <div className="mb-4">
                  ...
                  {errors.email && (<span className='text-red-500 text-md ml-2 mt-2'>{errors.email.message}</span>)}
                </div>
                ...
                <div className="mb-6">
                  ...
                  {errors.password && (<span className='text-red-500 text-md ml-2 mt-2'>{errors.password.message}</span>)}
                </div>
